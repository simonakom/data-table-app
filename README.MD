...
Application is developed using javascript and bootstrap that will combine the catalogue (representation of the products) and the CRUD table that will be used to manage the product list. 
